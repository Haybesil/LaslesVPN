  ...
  return (
    <div className="header-main">
      ...
      <div>
        ...
        <ul>
          <li>
            <Mark image={Check} title={'Powerful online protection.'} />
          </li>

          <li>
            <Mark image={Check} title={'Internet without Borders.'} />
          </li>

          <li>
            <Mark image={Check} title={'Supercharged VPN.'} />
          </li>

          <li>
            <Mark image={Check} title={'No specific time limits.'} />
          </li>
        </ul>
      </div>
    </div>
